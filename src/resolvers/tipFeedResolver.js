...
const createTipFeed = async (_, { symbol, targets, stopLoss, direction, date, currentValue, type, subscriptionId }) => {
    try {
        ...
        let createTipFeed = await tipFeedModel.create({
            symbol, targets, stopLoss, direction, date, currentValue, type, subscriptionId
        })
